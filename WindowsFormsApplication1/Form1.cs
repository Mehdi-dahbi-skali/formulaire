...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        static string chaine = @"Data Source=DESKTOP-3OPQBL6\SQLEXPRESS;Initial Catalog=base1;Integrated Security=True";
        ...
        private void btnInsert_Click(object sender, EventArgs e)
        {
            cnx.Open();
            cmd.Connection = cnx;
            cmd.CommandText = "insert into Tab2( id_d, nom_d ) values('" + txtId_dossier.Text + "','" + txtNom_dossier.Text + "') ";
            cmd.ExecuteNonQuery();
            cnx.Close();
        }
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            cnx.Open();
            cmd.Connection = cnx;
            cmd.CommandText = "update Tab2 set nom_d='" + txtNom_dossier.Text + "' where id_d='" + txtId_dossier.Text + "' ";
            cmd.ExecuteNonQuery();
            cnx.Close();
        }
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            cnx.Open();
            cmd.Connection = cnx;
            cmd.CommandText = "delete from Tab2 where id_d='" + txtId_dossier.Text + "' ";
            cmd.ExecuteNonQuery();
            cnx.Close();
        }
        ...
        {
            cnx.Open();
            cmd.CommandText = "select * from Tab2";
            cmd.Connection = cnx;
